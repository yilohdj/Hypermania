...
namespace Design.Configs
{
    ...
    public class ControlsConfig : ScriptableObject
    {
        ...
        private static readonly Dictionary<InputFlags, Binding> _defaultBindings = new()
        {
            ...
            { InputFlags.Mania1, new Binding(Key.D, Key.None, GamepadButtons.DpadRight, GamepadButtons.DpadUp) },
            ...
            { InputFlags.Super, new Binding(Key.P, Key.None, GamepadButtons.RightTrigger, GamepadButtons.None) },
        };
